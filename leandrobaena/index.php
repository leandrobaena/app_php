...
<html lang="en">
    <head>
        ...
        <title>Leandro Baena - Desarrollador de Software</title>
        <!-- Google Font -->
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="#WORK">Desarrollos</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <div class="home_text wow fadeInUp animated">
                                <h2>Desarrollador de sotware</h2>
                                <p>Desarrollando herramientas para que su negocio sea el mejor</p>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <div class="scroll_down">
                                ...
                                <h4>Despl&aacute;cese hacia abajo</h4>
                            </div>
                        </div>
                    </div>
                </div>            
                ...
                <div class="row">
                    <div class="col-md-3 text-center">
                        <div class="single_service wow fadeInUp" data-wow-delay="1s">
                            ...
                            <p>Diseño en formas normales, desarrollo de artefactos como triggers,
                                stored procedures, view, jobs; en motores MySQL, MSSQL, Oracle, SQLLite.</p>
                        </div>
                    </div>
                    <div class="col-md-3 text-center">
                        <div class="single_service wow fadeInUp" data-wow-delay="2s">
                            ...
                            <h2>Desarrollo</h2>
                            <p>Desarrollador Senior, con s&oacute;lidos conocimientos en
                                PHP, Java, .NET, Coldfusion, JQuery, Sencha ExtJS,
                                UML, SCRUM, diseño y arquitectura de Software,
                                levantamiento de requerimientos.</p>
                        </div>
                    </div>
                </div>            
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4  wow fadeInRight animated">
                        <p class="about_us_p">Me he desempe&ntilde;ado desde hace m&aacute;s de 7 a&ntilde;os en la
                            construcci&oacute;n de soluciones de software como empleado e independiente.</p>
                    </div>
                    <div class="col-md-4  wow fadeInRight animated">
                        <p class="about_us_p">Representante universitario a maratones de programación REDIS – ACIS.
                            Primer puesto a nivel interno. Mejor puesto alcanzado 4º, nivel Bogot&aacute;.</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <div class="work_title  wow fadeInUp animated">
                            ...
                            <img src="images/shape.png" alt="">
                            <p>Estos son algunos de los proyectos m&aacute;s recientes que he desarrollado.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-4 no_padding">
                        <div class="single_image">
                            ...
                            <div class="image_overlay">
                                <a href="http://susencargos.co" target="_blank">Ir al sitio</a>
                                <h2>SUSencargos.co</h2>
                                <h4>Front End - Zona de clientes</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 no_padding">
                        <div class="single_image">
                            ...
                            <div class="image_overlay">
                                <a href="http://susencargos.co/intranet">Ir al sitio</a>
                                <h2>SUSencargos.co</h2>
                                <h4>Intranet - Zona administrativa</h4>
                            </div>                        
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <div class="contact_title  wow fadeInUp animated">
                            <h1>Contacto</h1>
                            <img src="images/shape.png" alt="">
                            <p>Si desea conocer m&aacute;s de mi trabajo o contactarme
                                para el desarrollo de su proyeto, por favor diligencie
                                el siguiente formulario o h&aacute;galo a trav&eacute;s
                                de los otros canales mencionados.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-3  wow fadeInLeft animated">
                        <div class="single_contact_info">
                            ...
                            <p>+57 315 838 98 33</p>
                        </div>
                        <div class="single_contact_info">
                            <h2>Email</h2>
                            <p>leandrobaena@gmail.com</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center   wow fadeInUp animated">
                            <div class="social">
                                ...
                                <ul class="icon_list">
                                    <li><a href="https://www.facebook.com/leandrobaena" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://twitter.com/leandrobaena" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="https://plus.google.com/+LeandroBaenaTorres" target="_blank"><i class="fa fa-google-plus"></i></a></li>
                                    <li><a href="co.linkedin.com/in/leandrobaena" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
